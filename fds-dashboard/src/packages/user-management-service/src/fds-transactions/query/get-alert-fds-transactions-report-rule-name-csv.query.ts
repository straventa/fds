...
export function getFdsTransactionRuleNameCsvApi({
  startDate,
  endDate,
}: {
  startDate: Date;
  ...
  return userManagementServiceRawAxios
    .get(`/fds-transaction/report/rule-name/csv`, {
      params: {
        startDate: startDate,
        endDate: endDate,
      },
...
export function useGetFdsTransactionRuleNameCsvQuery() {
  return useMutation({
    mutationFn: getFdsTransactionRuleNameCsvApi,
    onSuccess: (data) => {
