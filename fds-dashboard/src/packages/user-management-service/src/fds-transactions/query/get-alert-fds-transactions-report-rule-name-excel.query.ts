...
export function getFdsTransactionRuleNameExcelApi({
  startDate,
  endDate,
}: {
  startDate: Date;
  ...
  return userManagementServiceRawAxios
    .get(`/fds-transaction/report/rule-name/excel`, {
      params: {
        startDate: startDate,
        endDate: endDate,
      },
...
export function useGetFdsTransactionRuleNameExcelQuery() {
  return useMutation({
    mutationFn: getFdsTransactionRuleNameExcelApi,
    onSuccess: (data) => {
