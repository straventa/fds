...
export function getAlertFdsTransactionAnalystCsvApi({
  startDate,
  endDate,
}: {
  startDate: Date;
  ...
  return userManagementServiceRawAxios
    .get(`/fds-transaction/report/analyst/csv`, {
      params: {
        startDate: startDate,
        endDate: endDate,
      },
...
export function useGetAlertFdsTransactionAnalystCsvQuery() {
  return useMutation({
    mutationFn: getAlertFdsTransactionAnalystCsvApi,
    onSuccess: (data) => {
