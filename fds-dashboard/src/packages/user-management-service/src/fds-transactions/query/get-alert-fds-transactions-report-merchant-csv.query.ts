...
export function getFdsTransactionMerchantCsvApi({
  startDate,
  endDate,
}: {
  startDate: Date;
  ...
  return userManagementServiceRawAxios
    .get(`/fds-transaction/report/merchant/csv`, {
      params: {
        startDate: startDate,
        endDate: endDate,
      },
...
export function useGetFdsTransactionMerchantCsvQuery() {
  return useMutation({
    mutationFn: getFdsTransactionMerchantCsvApi,
    onSuccess: (data) => {
